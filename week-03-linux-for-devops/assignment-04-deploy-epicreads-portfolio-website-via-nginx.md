...
![alt text](<sudo systemctl status nginx --no-pager showing Active (running) for assignment 4.png>)
...
![alt text](<ls -la assignment 4.png>)
...
![alt text](<footer showing your Full Name, Group, Week, and Date.png>)
...
![alt text](<sudo nginx -t for assignment task 3.png>)

#### Screenshot 4 — Output of `ls /var/www/html` showing deployed website files

![alt text](<ls -la var www html for assignment 4 task 4.png>)
...
![alt text](<ls -la var www html for assignment 4 task 4 for blog.png>)

#### Screenshot 6 — Browser showing the live website with your Full Name and deployment details in the footer

![alt text](<Browser showing footer of portfolio.png>)
...
![alt text](<systemctl is enable nginx.png>)


#### Screenshot 8 — Output of `curl -I http://localhost` showing 200 OK

![alt text](<curl -I http public ip for assignment 4 task 4.png>)
...
![alt text](<Linked Post for assignment 4.png>)
