...
![alt text](<Claude without CLAUDE.md.png>)
...
![alt text](<Auto generated CLAUDE.md 1.png>)
...
![alt text](<CLAUDEmd showing on my forked repo after commit.png>)
...
https://github.com/Felimek28/Ultimate-Agentic-DevOps-with-Claude-Code
