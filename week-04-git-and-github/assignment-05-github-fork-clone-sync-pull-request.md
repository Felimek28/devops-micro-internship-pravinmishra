...
![alt text](<Your fork page with your username and devops-micro-internship-interviews visible in the browser URL.png>)
...
![alt text](<Output of git config --global --get credential.helper HTTPS.png>)
...
![alt text](<Output of git remote -v showing origin pointing to our fork and upstream pointing to pravinmishraaws devops-micro-internship-interviews 1.png>)
...
![alt text](<Output of git status showing pull_request.md modified before staging.png>)


#### Screenshot 5 — Output of `git commit`


![alt text](<Output of git commit for pull request.png>)
...
![alt text](<Output of git push -u origin feature-readme-update showing a successful push.png>)


#### Screenshot 7 — Your fork on GitHub showing `feature-readme-update` in the branch selector or a "Compare & pull request" banner


![alt text](<Your fork on GitHub showing feature-readme-update in the branch selector .png>)
...
![alt text](<Pull Request creation page showing the correct base repository branch and head repository branch.png>)


#### Screenshot 9 — Successfully created Pull Request page with the PR number visible


![alt text](<Successfully created Pull Request page with the PR number visible.png>)
...
https://github.com/pravinmishraaws/devops-micro-internship-interviews/pull/457
...
![alt text](<Linkedin post for pull request.png>)
